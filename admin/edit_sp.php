            ...
            <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <?php 
                                $masp = $_GET['id'];
                                $sql = $conn->query("SELECT * FROM hanghoa WHERE MSHH='$masp'");
                                $row = $sql->fetch_assoc();
                            ?>
                            <div class="position-center">
                                <form role="form" action="xuli_admin/themsp.php" method="POST">
                                <div class="form-group">
                                    <label for="mahh">Mã số hàng hóa (MSHH)</label>
                                    <input type="text" name="mshh" class="form-control" value="<?php echo $row['MSHH']; ?>" id="mahh" placeholder="Nhập mã số hàng hóa">
                                </div>
                                <div class="form-group">
                                    <label for="tenhh">Tên hàng hóa</label>
                                    <input type="text" name="name" class="form-control" value="<?php echo $row['TenHH']; ?>" id="tenhh" placeholder="Nhập tên hàng hóa">
                                </div>
                                <div class="form-group">
                                    <label for="giahh">Giá</label>
                                    <input type="text" name="gia" class="form-control" value="<?php echo $row['Gia']; ?>" id="giahh" placeholder="Nhập giá">
                                </div>
                                <div class="form-group">
                                    <label for="sl">Số lượng</label>
                                    <input type="text" name="soluong" class="form-control" value="<?php echo $row['SoLuongHang']; ?>" id="sl" placeholder="Nhập số lượng">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mota" class="form-control" value="<?php echo $row['MoTaHH']; ?>" id="mt" placeholder="Mô tả">
                                </div>
                                <!-- <div class="form-group">
                                    <label for="img">Hình ảnh sản phẩm</label>
                                    <input type="file" name="image" value="<?php echo $row['Hinh']; ?>" id="img">
                                </div> -->
