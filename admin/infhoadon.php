  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          <?php
            $sql = $conn->query("SELECT * FROM dathang as a, chitietdh as b WHERE a.SoDonDH = b.MaDH");
          ...
          ?>    
            <tr>
              ...
              <td><a href='' ui-toggle-class=''><i class='fa fa-check text-success text-active'></i><i class='fa fa-times text-danger text'></i></a></td>
            </tr>
          <?php
            } 
          ?>                                        
